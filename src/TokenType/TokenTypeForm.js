...
import {tokenTypeActions, categoryActions, departmentActions, organizationActions} from "../_actions";
...
export const TokenTypeForm = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if(id === undefined) {
            dispatch(tokenTypeActions.add(catCode,{name, tokenPrefix}));
        } else {
            dispatch(tokenTypeActions.edit(catCode, {name, tokenPrefix, status}, code));
        }
        navigate("/token-type", {
            state:{
                orgCode,
